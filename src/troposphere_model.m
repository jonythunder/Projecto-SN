function [troposphere_delay] = troposphere_model(position_xyz,satellite_xyz,WN,TOW)
%TROPOSPHERE_MODEL Computes the troposphere delay
%   Given a receiver's position (in xyz), the day of the year and the satellite positions, computes
